...
Renderer.prototype.link = function(href, title, text) {
  if (this.options.sanitize) {
	...
	if(!href.match(urlPattern) && !href.match(telPattern)  && !href.match(emailPattern)) { href.split('.md').length<2 ? href=href+'.md' : 0; var out = '<a href="' +  window.content.location.href.split('mcnotes/')[0]+"mcnotes/"+"mcnotes/"+ href + '" target="_blank"';}
